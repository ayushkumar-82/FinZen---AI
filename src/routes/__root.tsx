...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FinPilot AI — Your Personal AI Financial Advisor" },
      { name: "description", content: "AI-powered personal finance dashboard: analyze expenses, plan goals, optimize taxes, and get intelligent financial guidance." },
      { property: "og:title", content: "FinPilot AI — Your Personal AI Financial Advisor" },
      { property: "og:description", content: "AI-powered personal finance dashboard with expense analytics, goal planning, and an intelligent AI advisor." },
